...
public class CategoriaDAO {
    ...
    public boolean inserir(Categoria categoria) {
        ...
        try {
            ...
            System.err.println("Erro ao inserir Categoria "+ex);
            return false;
        }
    }
    ...
    public boolean alterar(Categoria categoria) {
        ...
        try {
            ...
            System.err.println("Erro ao atualizar Categoria "+ex);
            return false;
        }
    }
    ...
    public boolean remover(Categoria categoria) {
        ...
        try {
            ...
            System.err.println("Erro ao remover Categoria "+ex);            
            return false;
        }
    }
    ...
    public List<Categoria> listar() {
        ...
        try {
           ...
           System.err.println("Erro ao listar Categoria "+ex);
        }
        return retorno;
    }
    ...
    public Categoria buscar(Categoria categoria) {
        ...
        try {
            ...
            System.err.println("Erro ao buscar Categoria "+ex);
        }
        return retorno;
    }
}
