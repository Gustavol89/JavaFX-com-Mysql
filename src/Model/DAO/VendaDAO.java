    ...
    public boolean inserir(Venda venda) {
        ...
        try {
            ...
            return true;
              ...
              System.err.println("Erro ao inserir venda "+ex);
            return false;
        }
    }
    ...
    public boolean alterar(Venda venda) {
        ...
        try {
            ...
            return true;
               ...
               System.err.println("Erro ao atualizar venda "+ex);
            return false;
        }
    }
    ...
    public List<Venda> listar() {
        ...
        try {
            ...
            while (resultado.next()) {
               ...
               System.err.println("Erro ao listar venda "+ex);
        }
        return retorno;
    }
    ...
    public Venda buscar(Venda venda) {
        ...
        try {
            ...
            if (resultado.next()) {
               ...
               System.err.println("Erro ao buscar venda "+ex);
        }
        return retorno;
    }
    ...
    public Venda buscarUltimaVenda() {
        ...
        try {
            ...
            if (resultado.next()) {
               ...
               System.err.println("Erro ao buscar ultima venda  "+ex);
        }
        return retorno;
    }
    ...
    public Map<Integer, ArrayList> listarQuantidadeVendasPorMes() {
        ...
        try {
            ...
            return retorno;
               ...
               System.err.println("Erro ao listar quantidade venda por mes "+ex);
        }
        return retorno;
    }
}
