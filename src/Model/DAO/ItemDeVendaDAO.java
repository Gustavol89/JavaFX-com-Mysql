...
public class ItemDeVendaDAO {
    ...
    public boolean inserir(ItemDeVenda itemDeVenda) {
        ...
        try {
            ...
            System.err.println("Erro ao inserir iten de venda "+ex);
            return false;
        }
    }
    ...
    public boolean remover(ItemDeVenda itemDeVenda) {
        ...
        try {
            ...
            return true;
               ...
               System.err.println("Erro ao remover iten de venda "+ex);
            return false;
        }
    }
    ...
    public List<ItemDeVenda> listar() {
        ...
        try {
            ...
            while (resultado.next()) {
              ...
              System.err.println("Erro ao listar iten de venda "+ex);
        }
        return retorno;
    }
    ...
    public List<ItemDeVenda> listarPorVenda(Venda venda) {
        ...
        try {
            ...
            while (resultado.next()) {
               ...
               System.err.println("Erro ao listar por venda iten de venda "+ex);
        }
        return retorno;
    }
    ...
    public ItemDeVenda buscar(ItemDeVenda itemDeVenda) {
        ...
        try {
            ...
            if (resultado.next()) {
              ...
              System.err.println("Erro ao buscar iten de venda "+ex);
        }
        return retorno;
    }
}
